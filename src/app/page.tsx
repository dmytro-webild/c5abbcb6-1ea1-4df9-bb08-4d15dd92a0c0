          ...
          dashboard={{
            ...
            stats: [
              ...
              },
              {
                ...
                values: [94, 96, 98],
                valueSuffix: "%",
                description: "Success rate across programs",
              },
              {
            ...
            listItems: [
              ...
              {
                icon: Users,
                title: "New Enrollment: 45 Students",
                status: "Processed",
              },
              {
                icon: Calendar,
      ...
      <div id="features" data-section="features">
        <FeatureCardSix
          ...
          features={[
            {
              id: 1,
              title: "Intelligent Student Management",
              description:
            ...
            {
              id: 2,
              title: "Staff Empowerment Suite",
              description:
                "Streamlined scheduling, attendance management, and professional development tracking. Empower educators with tools that reduce administrative burden and maximize teaching effectiveness.",
              imageSrc:
            ...
            },
            {
              ...
              description:
                "Real-time communication, progress reports, and involvement opportunities. Foster strong home-school partnerships that accelerate student success and satisfaction.",
              imageSrc:
            ...
            },
            {
              ...
              description:
                "Actionable insights into institutional performance, trend analysis, and predictive modeling. Make data-driven decisions that enhance operational efficiency and student outcomes.",
              imageSrc:
